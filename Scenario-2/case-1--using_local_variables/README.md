...
The environment-specific values—such as instance type, tags, and EBS volume size—are determined through local blocks, while the actual environment (dev, qa, or prod) is selected using the variable provided in the respective tfvars file.

(terraform concepts used - variables ,tfvars ,locals ,output, data)
